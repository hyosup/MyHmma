		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MY PAY ",
									"targetURL": "#comhmmausamyhmmamypayzpayintro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzpayintro-display": {
								"semanticObject": "comhmmausamyhmmamypayzpayintro",
								"action": "display",
								"description": "MY PAY ",
								"title": "MY PAY ",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zpayintro",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zpayintro")
								}
							}
						}
					}
