		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP CRUD",
									"targetURL": "#comcrudzsapcrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcrudzsapcrud-display": {
								"semanticObject": "comcrudzsapcrud",
								"action": "display",
								"description": "SAP CRUD",
								"title": "SAP CRUD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crud.zsapcrud",
									"url": sap.ui.require.toUrl("com/crud/zsapcrud")
								}
							}
						}
					}
