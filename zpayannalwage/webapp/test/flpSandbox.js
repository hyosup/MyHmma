		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comhmmausamyhmmamypayzpayannalwage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzpayannalwage-display": {
								"semanticObject": "comhmmausamyhmmamypayzpayannalwage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zpayannalwage",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zpayannalwage")
								}
							}
						}
					}
