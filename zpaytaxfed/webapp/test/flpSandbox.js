		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAXES FEDERAL",
									"targetURL": "#comhmmausamyhmmamypayzpaytaxfed-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzpaytaxfed-display": {
								"semanticObject": "comhmmausamyhmmamypayzpaytaxfed",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zpaytaxfed",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zpaytaxfed")
								}
							}
						}
					}
