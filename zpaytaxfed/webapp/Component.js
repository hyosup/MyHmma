...
sap.ui.define([
        ...
        "sap/ui/Device",
        "com/hmmausa/myhmma/mypay/zpaytaxfed/model/models"
    ],
    function (UIComponent, JSONModel, Currency, Device, models) {
        "use strict";

        return UIComponent.extend("com.hmmausa.myhmma.mypay.zpaytaxfed.Component", {
            metadata: {
                manifest: "json"
            },
            ...
            init: function () {
				...
				var oData = {
					...
					sample: {
						...
						Badge: '1234567',
                        Taxauthority:'[FED] Federal',
                        Fillingstatus:'[02] Married Filling Joint Return',
                        Taxlevel:'[A] Federal',
                        Allowances : '02',
                        Withholding : '0',
						ChargesN: '1',
