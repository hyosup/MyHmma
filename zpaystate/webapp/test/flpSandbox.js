		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PAY STATEMENT",
									"targetURL": "#comhmmausamyhmmamypayzpaystate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamypayzpaystate-display": {
								"semanticObject": "comhmmausamyhmmamypayzpaystate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mypay.zpaystate",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mypay/zpaystate")
								}
							}
						}
					}
