		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comhmmausamyhmmamybenefitzbenoverview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhmmausamyhmmamybenefitzbenoverview-display": {
								"semanticObject": "comhmmausamyhmmamybenefitzbenoverview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hmmausa.myhmma.mybenefit.zbenoverview",
									"url": sap.ui.require.toUrl("com/hmmausa/myhmma/mybenefit/zbenoverview")
								}
							}
						}
					}
